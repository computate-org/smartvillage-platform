 ...
 * </li>
 * </ol>
 * <h1>About the VehicleStep class and it's generated class VehicleStepGen&lt;MapResult&gt;: </h1>
 * <p>
 ...
 * </p>
 * <p>This class contains a comment <b>"Color: blue"</b>, which styles the VehicleStep page "blue". 
...
public abstract class VehicleStepGen<DEV> extends MapResult {
	...
	/**	<br> The entity color
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.model.traffic.vehicle.step.VehicleStep&fq=entiteVar_enUS_indexed_string:color">Find the entity color in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setColor(String o) {
		this.color = VehicleStep.staticSetColor(siteRequest_, o);
	}
	public static String staticSetColor(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected VehicleStep colorInit() {
	...
	public static String staticSearchFqColor(SiteRequestEnUS siteRequest_, String o) {
		return VehicleStep.staticSearchStrColor(siteRequest_, VehicleStep.staticSearchColor(siteRequest_, VehicleStep.staticSetColor(siteRequest_, o)));
	}
	...
	public static Object staticSetVehicleStep(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		...
		case "color":
			return VehicleStep.staticSetColor(siteRequest_, o);
			default:
	...
	public static Object staticSearchVehicleStep(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "color":
			return VehicleStep.staticSearchColor(siteRequest_, (String)o);
			default:
	...
	public static String staticSearchStrVehicleStep(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		...
		case "color":
			return VehicleStep.staticSearchStrColor(siteRequest_, (String)o);
			default:
	...
	public static String staticSearchFqVehicleStep(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		...
		case "color":
			return VehicleStep.staticSearchFqColor(siteRequest_, o);
			default:
	...
	public void storeVehicleStep(SolrResponse.Doc doc) {
		...
		oVehicleStep.setColor(Optional.ofNullable(doc.get("color_docvalues_string")).map(v -> v.toString()).orElse(null));
