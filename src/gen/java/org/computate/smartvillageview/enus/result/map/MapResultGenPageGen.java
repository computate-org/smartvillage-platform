 ...
 * <ol>
 * <li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class MapResultGenPageGen into the class MapResultGenPage. 
 * </li>
 ...
 * </li>
 * </ol>
 * <h1>About the MapResultGenPage class and it's generated class MapResultGenPageGen&lt;BaseResultPage&gt;: </h1>
 * <p>
 * This Java class extends a generated Java class built by the <a href="https://github.com/computate-org/computate">https://github.com/computate-org/computate</a> project. 
 * Whenever this Java class is modified or touched, the watch service installed as described in the README, indexes all the information about this Java class in a local Apache Solr Search Engine. 
 * If you are running the service, you can see the indexed data about this Java Class here: 
 * </p>
 * <p><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage">Find the class MapResultGenPage in Solr. </a></p>
 * <p>
 ...
 * curl 'http://localhost:8983/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
 * </p>
 * <p>
...
public abstract class MapResultGenPageGen<DEV> extends BaseResultPage {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:searchListMapResult_">Find the entity searchListMapResult_ in Solr</a>
	 * <br>
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:pageResponse">Find the entity pageResponse in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setPageResponse(String o) {
		this.pageResponse = MapResultGenPage.staticSetPageResponse(siteRequest_, o);
	}
	public static String staticSetPageResponse(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage pageResponseInit() {
	...
	public static String staticSearchFqPageResponse(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrPageResponse(siteRequest_, MapResultGenPage.staticSearchPageResponse(siteRequest_, MapResultGenPage.staticSetPageResponse(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultZoneId">Find the entity defaultZoneId in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultZoneId(String o) {
		this.defaultZoneId = MapResultGenPage.staticSetDefaultZoneId(siteRequest_, o);
	}
	public static String staticSetDefaultZoneId(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage defaultZoneIdInit() {
	...
	public static String staticSearchFqDefaultZoneId(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultZoneId(siteRequest_, MapResultGenPage.staticSearchDefaultZoneId(siteRequest_, MapResultGenPage.staticSetDefaultZoneId(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultTimeZone">Find the entity defaultTimeZone in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected MapResultGenPage defaultTimeZoneInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultLocaleId">Find the entity defaultLocaleId in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultLocaleId(String o) {
		this.defaultLocaleId = MapResultGenPage.staticSetDefaultLocaleId(siteRequest_, o);
	}
	public static String staticSetDefaultLocaleId(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage defaultLocaleIdInit() {
	...
	public static String staticSearchFqDefaultLocaleId(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultLocaleId(siteRequest_, MapResultGenPage.staticSearchDefaultLocaleId(siteRequest_, MapResultGenPage.staticSetDefaultLocaleId(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultLocale">Find the entity defaultLocale in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected MapResultGenPage defaultLocaleInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeGap">Find the entity defaultRangeGap in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeGap(String o) {
		this.defaultRangeGap = MapResultGenPage.staticSetDefaultRangeGap(siteRequest_, o);
	}
	public static String staticSetDefaultRangeGap(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage defaultRangeGapInit() {
	...
	public static String staticSearchFqDefaultRangeGap(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultRangeGap(siteRequest_, MapResultGenPage.staticSearchDefaultRangeGap(siteRequest_, MapResultGenPage.staticSetDefaultRangeGap(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeEnd">Find the entity defaultRangeEnd in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeEnd(String o) {
		this.defaultRangeEnd = MapResultGenPage.staticSetDefaultRangeEnd(siteRequest_, o);
	}
	...
	protected MapResultGenPage defaultRangeEndInit() {
	...
	public static String staticSearchFqDefaultRangeEnd(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultRangeEnd(siteRequest_, MapResultGenPage.staticSearchDefaultRangeEnd(siteRequest_, MapResultGenPage.staticSetDefaultRangeEnd(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeStart">Find the entity defaultRangeStart in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeStart(String o) {
		this.defaultRangeStart = MapResultGenPage.staticSetDefaultRangeStart(siteRequest_, o);
	}
	...
	protected MapResultGenPage defaultRangeStartInit() {
	...
	public static String staticSearchFqDefaultRangeStart(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultRangeStart(siteRequest_, MapResultGenPage.staticSearchDefaultRangeStart(siteRequest_, MapResultGenPage.staticSetDefaultRangeStart(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultRangeVar">Find the entity defaultRangeVar in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultRangeVar(String o) {
		this.defaultRangeVar = MapResultGenPage.staticSetDefaultRangeVar(siteRequest_, o);
	}
	public static String staticSetDefaultRangeVar(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage defaultRangeVarInit() {
	...
	public static String staticSearchFqDefaultRangeVar(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultRangeVar(siteRequest_, MapResultGenPage.staticSearchDefaultRangeVar(siteRequest_, MapResultGenPage.staticSetDefaultRangeVar(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetSort">Find the entity defaultFacetSort in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetSort(String o) {
		this.defaultFacetSort = MapResultGenPage.staticSetDefaultFacetSort(siteRequest_, o);
	}
	public static String staticSetDefaultFacetSort(SiteRequestEnUS siteRequest_, String o) {
		return o;
	}
	protected MapResultGenPage defaultFacetSortInit() {
	...
	public static String staticSearchFqDefaultFacetSort(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultFacetSort(siteRequest_, MapResultGenPage.staticSearchDefaultFacetSort(siteRequest_, MapResultGenPage.staticSetDefaultFacetSort(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetLimit">Find the entity defaultFacetLimit in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetLimit(String o) {
		this.defaultFacetLimit = MapResultGenPage.staticSetDefaultFacetLimit(siteRequest_, o);
	}
	...
	protected MapResultGenPage defaultFacetLimitInit() {
	...
	public static String staticSearchFqDefaultFacetLimit(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultFacetLimit(siteRequest_, MapResultGenPage.staticSearchDefaultFacetLimit(siteRequest_, MapResultGenPage.staticSetDefaultFacetLimit(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultFacetMinCount">Find the entity defaultFacetMinCount in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultFacetMinCount(String o) {
		this.defaultFacetMinCount = MapResultGenPage.staticSetDefaultFacetMinCount(siteRequest_, o);
	}
	...
	protected MapResultGenPage defaultFacetMinCountInit() {
	...
	public static String staticSearchFqDefaultFacetMinCount(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultFacetMinCount(siteRequest_, MapResultGenPage.staticSearchDefaultFacetMinCount(siteRequest_, MapResultGenPage.staticSetDefaultFacetMinCount(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:defaultPivotMinCount">Find the entity defaultPivotMinCount in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDefaultPivotMinCount(String o) {
		this.defaultPivotMinCount = MapResultGenPage.staticSetDefaultPivotMinCount(siteRequest_, o);
	}
	...
	protected MapResultGenPage defaultPivotMinCountInit() {
	...
	public static String staticSearchFqDefaultPivotMinCount(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDefaultPivotMinCount(siteRequest_, MapResultGenPage.staticSearchDefaultPivotMinCount(siteRequest_, MapResultGenPage.staticSetDefaultPivotMinCount(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_LOCATION">Find the entity DEFAULT_MAP_LOCATION in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_LOCATION(String o) {
		this.DEFAULT_MAP_LOCATION = MapResultGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
	}
	...
	protected MapResultGenPage DEFAULT_MAP_LOCATIONInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_LOCATION(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, MapResultGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, MapResultGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o)));
	}
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:DEFAULT_MAP_ZOOM">Find the entity DEFAULT_MAP_ZOOM in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	public void setDEFAULT_MAP_ZOOM(String o) {
		this.DEFAULT_MAP_ZOOM = MapResultGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
	}
	...
	protected MapResultGenPage DEFAULT_MAP_ZOOMInit() {
	...
	public static String staticSearchFqDEFAULT_MAP_ZOOM(SiteRequestEnUS siteRequest_, String o) {
		return MapResultGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, MapResultGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, MapResultGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o)));
	}
	 ...
	 *  It is constructed before being initialized with the constructor by default. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:listMapResult">Find the entity listMapResult in Solr</a>
	 * <br>
	...
	/**	<br> The entity stats
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:stats">Find the entity stats in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected MapResultGenPage statsInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:facetCounts">Find the entity facetCounts in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	protected MapResultGenPage facetCountsInit() {
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:mapResultCount">Find the entity mapResultCount in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:mapResult_">Find the entity mapResult_ in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	...
	/**	<br> The entity id
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:id">Find the entity id in Solr</a>
	 * <br>
	 * @param w is for wrapping a value to assign to this entity during initialization. 
	 **/
	 ...
	 *  is defined as null before being initialized. 
	 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstEntite_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultGenPage&fq=entiteVar_enUS_indexed_string:pageUriMapResult">Find the entity pageUriMapResult in Solr</a>
	 * <br>
	...
	public Object obtainMapResultGenPage(String var) {
		...
		switch(var) {
			...
			case "pageResponse":
				return oMapResultGenPage.pageResponse;
			case "defaultZoneId":
				return oMapResultGenPage.defaultZoneId;
			case "defaultTimeZone":
				return oMapResultGenPage.defaultTimeZone;
			case "defaultLocaleId":
				return oMapResultGenPage.defaultLocaleId;
			case "defaultLocale":
				return oMapResultGenPage.defaultLocale;
			case "defaultRangeGap":
				return oMapResultGenPage.defaultRangeGap;
			case "defaultRangeEnd":
				return oMapResultGenPage.defaultRangeEnd;
			case "defaultRangeStart":
				return oMapResultGenPage.defaultRangeStart;
			case "defaultRangeVar":
				return oMapResultGenPage.defaultRangeVar;
			case "defaultFacetSort":
				return oMapResultGenPage.defaultFacetSort;
			case "defaultFacetLimit":
				return oMapResultGenPage.defaultFacetLimit;
			case "defaultFacetMinCount":
				return oMapResultGenPage.defaultFacetMinCount;
			case "defaultPivotMinCount":
				return oMapResultGenPage.defaultPivotMinCount;
			case "DEFAULT_MAP_LOCATION":
				return oMapResultGenPage.DEFAULT_MAP_LOCATION;
			case "DEFAULT_MAP_ZOOM":
				return oMapResultGenPage.DEFAULT_MAP_ZOOM;
			case "listMapResult":
				return oMapResultGenPage.listMapResult;
			case "stats":
				return oMapResultGenPage.stats;
			case "facetCounts":
				return oMapResultGenPage.facetCounts;
			case "mapResultCount":
	...
	public static Object staticSetMapResultGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		switch(entityVar) {
		case "pageResponse":
			return MapResultGenPage.staticSetPageResponse(siteRequest_, o);
		case "defaultZoneId":
			return MapResultGenPage.staticSetDefaultZoneId(siteRequest_, o);
		case "defaultLocaleId":
			return MapResultGenPage.staticSetDefaultLocaleId(siteRequest_, o);
		case "defaultRangeGap":
			return MapResultGenPage.staticSetDefaultRangeGap(siteRequest_, o);
		case "defaultRangeEnd":
			return MapResultGenPage.staticSetDefaultRangeEnd(siteRequest_, o);
		case "defaultRangeStart":
			return MapResultGenPage.staticSetDefaultRangeStart(siteRequest_, o);
		case "defaultRangeVar":
			return MapResultGenPage.staticSetDefaultRangeVar(siteRequest_, o);
		case "defaultFacetSort":
			return MapResultGenPage.staticSetDefaultFacetSort(siteRequest_, o);
		case "defaultFacetLimit":
			return MapResultGenPage.staticSetDefaultFacetLimit(siteRequest_, o);
		case "defaultFacetMinCount":
			return MapResultGenPage.staticSetDefaultFacetMinCount(siteRequest_, o);
		case "defaultPivotMinCount":
			return MapResultGenPage.staticSetDefaultPivotMinCount(siteRequest_, o);
		case "DEFAULT_MAP_LOCATION":
			return MapResultGenPage.staticSetDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return MapResultGenPage.staticSetDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "mapResultCount":
	...
	public static Object staticSearchMapResultGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		switch(entityVar) {
		case "pageResponse":
			return MapResultGenPage.staticSearchPageResponse(siteRequest_, (String)o);
		case "defaultZoneId":
			return MapResultGenPage.staticSearchDefaultZoneId(siteRequest_, (String)o);
		case "defaultLocaleId":
			return MapResultGenPage.staticSearchDefaultLocaleId(siteRequest_, (String)o);
		case "defaultRangeGap":
			return MapResultGenPage.staticSearchDefaultRangeGap(siteRequest_, (String)o);
		case "defaultRangeEnd":
			return MapResultGenPage.staticSearchDefaultRangeEnd(siteRequest_, (ZonedDateTime)o);
		case "defaultRangeStart":
			return MapResultGenPage.staticSearchDefaultRangeStart(siteRequest_, (ZonedDateTime)o);
		case "defaultRangeVar":
			return MapResultGenPage.staticSearchDefaultRangeVar(siteRequest_, (String)o);
		case "defaultFacetSort":
			return MapResultGenPage.staticSearchDefaultFacetSort(siteRequest_, (String)o);
		case "defaultFacetLimit":
			return MapResultGenPage.staticSearchDefaultFacetLimit(siteRequest_, (Integer)o);
		case "defaultFacetMinCount":
			return MapResultGenPage.staticSearchDefaultFacetMinCount(siteRequest_, (Integer)o);
		case "defaultPivotMinCount":
			return MapResultGenPage.staticSearchDefaultPivotMinCount(siteRequest_, (Integer)o);
		case "DEFAULT_MAP_LOCATION":
			return MapResultGenPage.staticSearchDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return MapResultGenPage.staticSearchDEFAULT_MAP_ZOOM(siteRequest_, (BigDecimal)o);
		case "mapResultCount":
	...
	public static String staticSearchStrMapResultGenPage(String entityVar, SiteRequestEnUS siteRequest_, Object o) {
		switch(entityVar) {
		case "pageResponse":
			return MapResultGenPage.staticSearchStrPageResponse(siteRequest_, (String)o);
		case "defaultZoneId":
			return MapResultGenPage.staticSearchStrDefaultZoneId(siteRequest_, (String)o);
		case "defaultLocaleId":
			return MapResultGenPage.staticSearchStrDefaultLocaleId(siteRequest_, (String)o);
		case "defaultRangeGap":
			return MapResultGenPage.staticSearchStrDefaultRangeGap(siteRequest_, (String)o);
		case "defaultRangeEnd":
			return MapResultGenPage.staticSearchStrDefaultRangeEnd(siteRequest_, (Date)o);
		case "defaultRangeStart":
			return MapResultGenPage.staticSearchStrDefaultRangeStart(siteRequest_, (Date)o);
		case "defaultRangeVar":
			return MapResultGenPage.staticSearchStrDefaultRangeVar(siteRequest_, (String)o);
		case "defaultFacetSort":
			return MapResultGenPage.staticSearchStrDefaultFacetSort(siteRequest_, (String)o);
		case "defaultFacetLimit":
			return MapResultGenPage.staticSearchStrDefaultFacetLimit(siteRequest_, (Integer)o);
		case "defaultFacetMinCount":
			return MapResultGenPage.staticSearchStrDefaultFacetMinCount(siteRequest_, (Integer)o);
		case "defaultPivotMinCount":
			return MapResultGenPage.staticSearchStrDefaultPivotMinCount(siteRequest_, (Integer)o);
		case "DEFAULT_MAP_LOCATION":
			return MapResultGenPage.staticSearchStrDEFAULT_MAP_LOCATION(siteRequest_, (JsonObject)o);
		case "DEFAULT_MAP_ZOOM":
			return MapResultGenPage.staticSearchStrDEFAULT_MAP_ZOOM(siteRequest_, (Double)o);
		case "mapResultCount":
	...
	public static String staticSearchFqMapResultGenPage(String entityVar, SiteRequestEnUS siteRequest_, String o) {
		switch(entityVar) {
		case "pageResponse":
			return MapResultGenPage.staticSearchFqPageResponse(siteRequest_, o);
		case "defaultZoneId":
			return MapResultGenPage.staticSearchFqDefaultZoneId(siteRequest_, o);
		case "defaultLocaleId":
			return MapResultGenPage.staticSearchFqDefaultLocaleId(siteRequest_, o);
		case "defaultRangeGap":
			return MapResultGenPage.staticSearchFqDefaultRangeGap(siteRequest_, o);
		case "defaultRangeEnd":
			return MapResultGenPage.staticSearchFqDefaultRangeEnd(siteRequest_, o);
		case "defaultRangeStart":
			return MapResultGenPage.staticSearchFqDefaultRangeStart(siteRequest_, o);
		case "defaultRangeVar":
			return MapResultGenPage.staticSearchFqDefaultRangeVar(siteRequest_, o);
		case "defaultFacetSort":
			return MapResultGenPage.staticSearchFqDefaultFacetSort(siteRequest_, o);
		case "defaultFacetLimit":
			return MapResultGenPage.staticSearchFqDefaultFacetLimit(siteRequest_, o);
		case "defaultFacetMinCount":
			return MapResultGenPage.staticSearchFqDefaultFacetMinCount(siteRequest_, o);
		case "defaultPivotMinCount":
			return MapResultGenPage.staticSearchFqDefaultPivotMinCount(siteRequest_, o);
		case "DEFAULT_MAP_LOCATION":
			return MapResultGenPage.staticSearchFqDEFAULT_MAP_LOCATION(siteRequest_, o);
		case "DEFAULT_MAP_ZOOM":
			return MapResultGenPage.staticSearchFqDEFAULT_MAP_ZOOM(siteRequest_, o);
		case "mapResultCount":
