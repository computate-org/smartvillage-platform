 ...
 * </li><li>You can add a class comment "{@inheritDoc}" if you wish to inherit the helpful inherited class comments from class MapResultPageGen into the class MapResultPage. 
 * </li>
 * <h3>About the MapResultPage class and it's generated class MapResultPageGen&lt;MapResultGenPage&gt;: </h3>extends MapResultPageGen
 * <p>
 * This Java class extends a generated Java class MapResultPageGen built by the <a href="https://github.com/computate-org/computate">https://github.com/computate-org/computate</a> project. 
 * Whenever this Java class is modified or touched, the watch service installed as described in the README, indexes all the information about this Java class in a local Apache Solr Search Engine. 
 * If you are running the service, you can see the indexed data about this Java Class here: 
 * </p>
 * <p><a href="http://localhost:44641/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultPage">Find the class MapResultPage in Solr. </a></p>
 * <p>
 * The extended class ending with "Gen" did not exist at first, but was automatically created by the same watch service based on the data retrieved from the local Apache Server search engine. 
 * The extended class contains many generated fields, getters, setters, initialization code, and helper methods to help build a website and API fast, reactive, and scalable. 
 * </p>
 * extends MapResultPageGen<MapResultGenPage>
 * <p>This <code>class MapResultPage extends MapResultPageGen&lt;MapResultGenPage&gt;</code>, which means it extends a newly generated MapResultPageGen. 
 * The generated <code>class MapResultPageGen extends MapResultGenPage</code> which means that MapResultPage extends MapResultPageGen which extends MapResultGenPage. 
 ...
 * Indexed: true
 * {@inheritDoc}
 * <p>By adding a class comment "{@inheritDoc}", the MapResultPage class will inherit the helpful inherited class comments from the super class MapResultPageGen. 
 * </p>
 * Rows: null
 * Model: true
 * Page: true
 ...
 *   This means that the MapResultPage Java class has promiseDeep methods which must be initialized asynchronously as a Vert.x Promise  instead of initDeep methods which are a simple non-asynchronous method. 
 * </p>
 * <p>
 ...
 * curl -k 'http://localhost:44641/solr/computate/update?commitWithin=1000&overwrite=true&wt=json' -X POST -H 'Content-type: text/xml' --data-raw '&lt;add&gt;&lt;delete&gt;&lt;query&gt;classeNomCanonique_enUS_indexed_string:org.computate.smartvillageview.enus.result.map.MapResultPage&lt;/query&gt;&lt;/delete&gt;&lt;/add&gt;'
 * </p>
 * <p>
