...
ALTER TABLE CrowdFlowObserved ADD COLUMN IF NOT EXISTS areaServed text;
...
ALTER TABLE CrowdFlowObserved ADD COLUMN IF NOT EXISTS location path;
...
ALTER TABLE CrowdFlowObserved ADD COLUMN IF NOT EXISTS type text;
...
ALTER TABLE TrafficFlowObserved ADD COLUMN IF NOT EXISTS location path;
