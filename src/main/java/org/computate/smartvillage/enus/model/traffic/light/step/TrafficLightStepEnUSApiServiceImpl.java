 ...
 * Translate: false
 **/
public class TrafficLightStepEnUSApiServiceImpl extends TrafficLightStepEnUSGenApiServiceImpl {

	public TrafficLightStepEnUSApiServiceImpl(EventBus eventBus, JsonObject config, WorkerExecutor workerExecutor, PgPool pgPool, KafkaProducer<String, String> kafkaProducer, WebClient webClient, OAuth2Auth oauth2AuthenticationProvider, AuthorizationProvider authorizationProvider, HandlebarsTemplateEngine templateEngine) {
