...
public class SiteHtmlEnUSApiServiceImpl extends SiteHtmlEnUSGenApiServiceImpl {
	...
	public SiteHtmlEnUSApiServiceImpl(EventBus eventBus, JsonObject config, WorkerExecutor workerExecutor, PgPool pgPool, WebClient webClient, OAuth2Auth oauth2AuthenticationProvider, AuthorizationProvider authorizationProvider) {
