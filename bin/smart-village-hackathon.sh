...
echo '  - security'
xdg-open 'https://console.apps.shift.nerc.mghpcc.org/k8s/ns/smart-village-faeeb6c/apps~v1~Deployment'
read -p "" < /dev/tty
echo '  - high availablity'
xdg-open 'https://console.apps.shift.nerc.mghpcc.org/k8s/ns/smart-village-faeeb6c/core~v1~Pod'
read -p "" < /dev/tty
echo '  - scalability'
xdg-open 'https://console.apps.shift.nerc.mghpcc.org/k8s/ns/smart-village-faeeb6c/apps~v1~Deployment'
read -p "" < /dev/tty
echo '  - updates'
xdg-open 'https://console.apps.shift.nerc.mghpcc.org/k8s/ns/smart-village-faeeb6c/image.openshift.io~v1~ImageStream'
read -p "" < /dev/tty
echo '  - storage'
...
echo ''
echo 'take a look into our New England Research Cloud cloud environment in production:'
xdg-open 'https://nerc.mghpcc.org/'
read -p "" < /dev/tty
